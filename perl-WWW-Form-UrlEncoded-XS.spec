...
Requires: perl-WWW-Form-UrlEncoded-XS-lib
Requires: perl-WWW-Form-UrlEncoded-XS-license
Requires: perl-WWW-Form-UrlEncoded-XS-man
...
%package man
Summary: man components for the perl-WWW-Form-UrlEncoded-XS package.
Group: Default

%description man
man components for the perl-WWW-Form-UrlEncoded-XS package.
...
mkdir -p %{_topdir}/BUILD/WWW-Form-UrlEncoded-XS-0.25/deblicense/
...
%install
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/perl-WWW-Form-UrlEncoded-XS
cp LICENSE %{buildroot}/usr/share/doc/perl-WWW-Form-UrlEncoded-XS/LICENSE
cp deblicense/copyright %{buildroot}/usr/share/doc/perl-WWW-Form-UrlEncoded-XS/deblicense_copyright
if test -f Makefile.PL; then
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/site_perl/5.26.1/x86_64-linux-thread-multi/WWW/Form/UrlEncoded/XS.pm

%files lib
%defattr(-,root,root,-)
/usr/lib/perl5/site_perl/5.26.1/x86_64-linux-thread-multi/auto/WWW/Form/UrlEncoded/XS/XS.so

%files license
%defattr(-,root,root,-)
/usr/share/doc/perl-WWW-Form-UrlEncoded-XS/LICENSE
/usr/share/doc/perl-WWW-Form-UrlEncoded-XS/deblicense_copyright
