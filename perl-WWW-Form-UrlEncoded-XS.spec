...
Version  : 0.27
Release  : 18
URL      : https://cpan.metacpan.org/authors/id/K/KA/KAZEBURO/WWW-Form-UrlEncoded-XS-0.27.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/K/KA/KAZEBURO/WWW-Form-UrlEncoded-XS-0.27.tar.gz
...
%prep
%setup -q -n WWW-Form-UrlEncoded-XS-0.27
cd %{_builddir}
tar xf %{_sourcedir}/libwww-form-urlencoded-xs-perl_0.25-1.debian.tar.xz
cd %{_builddir}/WWW-Form-UrlEncoded-XS-0.27
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/WWW-Form-UrlEncoded-XS-0.27/deblicense/
...
cp %{_builddir}/WWW-Form-UrlEncoded-XS-0.27/LICENSE %{buildroot}/usr/share/package-licenses/perl-WWW-Form-UrlEncoded-XS/220fe941787679d8a043c0444548ac186c86f309
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.34.0/x86_64-linux-thread-multi/WWW/Form/UrlEncoded/XS.pm
/usr/lib/perl5/vendor_perl/5.34.0/x86_64-linux-thread-multi/auto/WWW/Form/UrlEncoded/XS/XS.so
